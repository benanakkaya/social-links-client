...
const MobileMockup = () => {
    ...
    return (
        <div className="col-span-3 md:col-span-1 bg-white p-8 rounded-lg h-[696px]">
            <div className="w-full h-full relative flex items-center justify-center bg-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="308" height="632" fill={userInformation.profileColor} viewBox="0 0 308 632">
                    <path
                        stroke="#737373"
                    ...
                    {(userInformation.profilePicture || preview) ?
                        ...
                        :
                        <circle cx="153.5" cy="112" r="48" fill="#EFEBFF" />
                    }
                    {(userInformation.firstName || userInformation.lastName) ?
                        ...
                        :
                        <rect width="160" height="16" x="73.5" y="185" fill="#EFEBFF" rx="8" />
                    }
                    {userInformation.email && !userInformation.isHiddenEmail ?
                        ...
                        :
                        <rect width="72" height="8" x="117.5" y="214" fill="#EFEBFF" rx="4" />
                    }
                    {userInformation.links.length === 0 ?
                        <>
                            <rect width="237" height="44" x="35" y="278" fill="#EFEBFF" rx="8" />
                            <rect width="237" height="44" x="35" y="342" fill="#EFEBFF" rx="8" />
                            <rect width="237" height="44" x="35" y="406" fill="#EFEBFF" rx="8" />
                            <rect width="237" height="44" x="35" y="470" fill="#EFEBFF" rx="8" />
                            <rect width="237" height="44" x="35" y="534" fill="#EFEBFF" rx="8" />
                        </>
                        :
