...
import { editProfile, getUser, setNewProfilePicture, updateUserDetails } from '@/redux/User/UserSlice'
...
const ProfilePage = ({ params }) => {
    ...
    const { userInformation, newProfilePicture, buttonStatus } = useSelector(state => state.user)
